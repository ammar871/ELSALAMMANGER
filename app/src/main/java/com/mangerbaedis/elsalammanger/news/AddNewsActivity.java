...
import com.mangerbaedis.elsalammanger.databinding.ActivityAddNewsBinding;
...
ActivityAddNewsBinding binding;
    ...
    private void SendRetrofitNotifection(final String title, final String body, final String uri) {
        Data notifacation = new Data( title,body, uri,"com.bardisammar.elsalamcity.notifecation_NEWS_NOTIFICATION");
