package com.mangerbaedis.elsalammanger.pagesMarkets;
        ...
        import com.mangerbaedis.elsalammanger.databinding.ActivityAddProudctFagalaBinding;
...
public class AddProudctFagalaActivity extends AppCompatActivity implements OnMapReadyCallback
        , GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener
        , LocationListener {
    private static final int PICK_IMAGE = 1;
    ActivityAddProudctFagalaBinding binding;
    Uri saveuri;
    String imageUri;
    String tvadds;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_add_proudct_fagala);
        ...
        pd = new ProgressDialog(AddProudctFagalaActivity.this);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(AddProudctFagalaActivity.this, "من فضلك قم بتشغيل الموقع ", Toast.LENGTH_SHORT).show();
                    }
            ...
            imagefolder.putFile(saveuri).
                    addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            pd.dismiss();
                            Toast.makeText(AddProudctFagalaActivity.this, "upload...", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    pd.dismiss();
                    Toast.makeText(AddProudctFagalaActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            pd.show();
                ...
                catogry.push()
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(AddProudctFagalaActivity.this, "تمت الاضافة ", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(AddProudctFagalaActivity.this, PageFagalaActivity.class));
                        finish();
        ...
        mservies.sendNotifectoin(sender).enqueue(new Callback<MyResponse>() {
            ...
            public void onResponse(@NonNull Call<MyResponse> call, @NonNull Response<MyResponse> response) {
                if (response.code()==200){
                    Toast.makeText(AddProudctFagalaActivity.this, "تم الارسال ", Toast.LENGTH_SHORT).show();
