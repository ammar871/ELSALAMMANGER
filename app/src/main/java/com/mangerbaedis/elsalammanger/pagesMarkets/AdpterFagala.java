...
public class AdpterFagala  extends RecyclerView.Adapter<AdpterFagala.ViewHolderVidio> {


    private final ArrayList<Pro_Of_Product> list;
    private final Context mcontext;
    public static String key;

    public AdpterFagala(ArrayList<Pro_Of_Product> list, Context mcontext) {
