...
public class Adpter_Adds_Fagala extends RecyclerView.Adapter<Adpter_Adds_Fagala.ViewHolderVidio> {
    ...
    public Adpter_Adds_Fagala(ArrayList<Pro_Of_Product> list, Context mcontext) {
    ...
    private void detlete(String name, final int oasstion) {
        ...
        DatabaseReference refProduct = database.getReference().child("اعلانات");
    ...
    private void update(int passtion) {
        Intent intent = new Intent(mcontext, AddProudctFagalaActivity.class);
