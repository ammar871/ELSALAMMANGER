...
import com.mangerbaedis.elsalammanger.addProducts.UpdateActivity;
import com.mangerbaedis.elsalammanger.details.DetailsActivity;
...
public class AdpterProduct extends RecyclerView.Adapter<AdpterProduct.ViewHolderVidio> {
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                detlete(list.get(position).getName(), position);
   ...
   private void update(int passtion,String value) {
        Intent intent = new Intent(mcontext, UpdateActivity.class);
        intent.putExtra("productUpdate", list.get(passtion));
